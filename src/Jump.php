 ...
 * @method static Response|void success(string $msg, string $url = null, int $wait = null, array $header = [], mixed $data = null) 成功跳转
 * @method static Response|void error(string $msg, string $url = null, int $wait = null, array $header = [], mixed $data = null) 错误跳转
 * @method static Response|void redirect(string $url = null, string $msg = '', int $code = 302, array $header = []) 页面重定向
 * @method static Response|void result(mixed $data, mixed $code = null, string $msg = '', string $type = null, array $header = []) 返回封装后的API数据
